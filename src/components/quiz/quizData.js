const quiz = {
    ...
    'sports': {
        ...
        'football':   [
            ...
            {'question':'10 who has played for the chiefs and steelers', 'choices':['kelce','juju','AB','lamar'], 'correct':0},

        ],
        'soccer':   [
            {'question':'1 who is the last redbull mvp', 'choices':['messi','soccer guy','pele','ibrahim'], 'correct':0},
            {'question':'2 how many fifa bowls does messi have', 'choices':['ronaldino','cortex','neymar','bekcham'], 'correct':1},
            {'question':'3 who has played for the redbull and barcelona', 'choices':['clinton','forte','messi ','use'], 'correct':0},
            {'question':'4 who is the last redbull mvp', 'choices':['messi','soccer guy','pele','ibrahim'], 'correct':0},
            {'question':'5 how many fifa bowls does messi have', 'choices':['ronaldino','cortex','neymar','bekcham'], 'correct':1},
            {'question':'6 who has played for the redbull and barcelona', 'choices':['clinton','forte','messi ','use'], 'correct':0},
            {'question':'7 who is the last redbull mvp', 'choices':['messi','soccer guy','pele','ibrahim'], 'correct':0},
            {'question':'8 how many fifa bowls does messi have', 'choices':['ronaldino','cortex','neymar','bekcham'], 'correct':1},
            {'question':'9 who has played for the redbull and barcelona', 'choices':['clinton','forte','messi ','use'], 'correct':0},
            {'question':'10 who has played for the redbull and barcelona', 'choices':['clinton','forte','messi ','use'], 'correct':0},
